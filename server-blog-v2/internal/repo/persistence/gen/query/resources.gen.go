...
func newResource(db *gorm.DB, opts ...gen.DOOption) resource {
	...
	_resource.FileKey = field.NewString(tableName, "file_key")
	_resource.FileName = field.NewString(tableName, "file_name")
	_resource.FileHash = field.NewString(tableName, "file_hash")
	_resource.FileSize = field.NewInt64(tableName, "file_size")
	_resource.MimeType = field.NewString(tableName, "mime_type")
	_resource.UserUUID = field.NewString(tableName, "user_uuid")
	_resource.TranscodeStatus = field.NewInt16(tableName, "transcode_status")
	_resource.TranscodeKey = field.NewString(tableName, "transcode_key")
	_resource.ThumbnailKey = field.NewString(tableName, "thumbnail_key")
...
type resource struct {
	...
	TranscodeStatus field.Int16
	TranscodeKey    field.String
	ThumbnailKey    field.String
...
func (r *resource) updateTableName(table string) *resource {
	...
	r.TranscodeStatus = field.NewInt16(table, "transcode_status")
	r.TranscodeKey = field.NewString(table, "transcode_key")
	r.ThumbnailKey = field.NewString(table, "thumbnail_key")
...
func (r *resource) fillFieldMap() {
	...
	r.fieldMap["transcode_key"] = r.TranscodeKey
	r.fieldMap["thumbnail_key"] = r.ThumbnailKey
