...
func newFeedback(db *gorm.DB, opts ...gen.DOOption) feedback {
	...
	_feedback.Contact = field.NewString(tableName, "contact")
	_feedback.Reply = field.NewString(tableName, "reply")
	...
	_feedback.UserUUID = field.NewString(tableName, "user_uuid")
...
func (f *feedback) updateTableName(table string) *feedback {
	...
	f.Reply = field.NewString(table, "reply")
	f.Status = field.NewString(table, "status")
	f.CreatedAt = field.NewTime(table, "created_at")
	f.UpdatedAt = field.NewTime(table, "updated_at")
	f.DeletedAt = field.NewField(table, "deleted_at")
	f.UserUUID = field.NewString(table, "user_uuid")
...
func (f *feedback) fillFieldMap() {
	...
	f.fieldMap["reply"] = f.Reply
	f.fieldMap["status"] = f.Status
	f.fieldMap["created_at"] = f.CreatedAt
	f.fieldMap["updated_at"] = f.UpdatedAt
	f.fieldMap["deleted_at"] = f.DeletedAt
	f.fieldMap["user_uuid"] = f.UserUUID
}
