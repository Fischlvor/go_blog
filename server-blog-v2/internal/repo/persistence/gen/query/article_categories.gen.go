...
func newArticleCategory(db *gorm.DB, opts ...gen.DOOption) articleCategory {
	...
	_articleCategory.ID = field.NewInt64(tableName, "id")
	_articleCategory.Name = field.NewString(tableName, "name")
	_articleCategory.Slug = field.NewString(tableName, "slug")
	_articleCategory.ArticleCount = field.NewInt32(tableName, "article_count")
...
type IArticleCategoryDo interface {
	...
	Create(values ...*model.ArticleCategory) error
	CreateInBatches(values []*model.ArticleCategory, batchSize int) error
	Save(values ...*model.ArticleCategory) error
	First() (*model.ArticleCategory, error)
	Take() (*model.ArticleCategory, error)
	Last() (*model.ArticleCategory, error)
	Find() ([]*model.ArticleCategory, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.ArticleCategory, err error)
	FindInBatches(result *[]*model.ArticleCategory, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.ArticleCategory) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.ArticleCategory, error)
	FirstOrCreate() (*model.ArticleCategory, error)
	FindByPage(offset int, limit int) (result []*model.ArticleCategory, count int64, err error)
