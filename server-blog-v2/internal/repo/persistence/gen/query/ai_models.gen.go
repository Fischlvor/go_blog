...
func newAiModel(db *gorm.DB, opts ...gen.DOOption) aiModel {
	...
	_aiModel.DisplayName = field.NewString(tableName, "display_name")
	_aiModel.Provider = field.NewString(tableName, "provider")
	_aiModel.Endpoint = field.NewString(tableName, "endpoint")
	_aiModel.APIKey = field.NewString(tableName, "api_key")
	_aiModel.MaxTokens = field.NewInt32(tableName, "max_tokens")
	_aiModel.Temperature = field.NewFloat64(tableName, "temperature")
	_aiModel.IsActive = field.NewBool(tableName, "is_active")
...
func (a *aiModel) updateTableName(table string) *aiModel {
	...
	a.MaxTokens = field.NewInt32(table, "max_tokens")
...
func (a *aiModel) WithContext(ctx context.Context) IAiModelDo { return a.aiModelDo.WithContext(ctx) }
