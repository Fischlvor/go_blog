...
func newLink(db *gorm.DB, opts ...gen.DOOption) link {
	...
	_link.Sort = field.NewInt32(tableName, "sort")
	_link.IsVisible = field.NewBool(tableName, "is_visible")
...
func (l *link) updateTableName(table string) *link {
	...
	l.IsVisible = field.NewBool(table, "is_visible")
...
func (l *link) fillFieldMap() {
	...
	l.fieldMap["is_visible"] = l.IsVisible
